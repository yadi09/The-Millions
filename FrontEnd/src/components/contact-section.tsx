          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <Card className="bg-white/10 border-white/20">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">{content.actions[0]?.label || "Book a Free Consultation"}</h3>
            ...
            <Card className="bg-white/10 border-white/20">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">{content.actions[1]?.label || "WhatsApp Us Instantly"}</h3>
